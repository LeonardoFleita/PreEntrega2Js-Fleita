...
//Al ingresar el cliente le pregunta si ya ha comprado, si la respuesta es "no" el usuario se registra,si la respuesta es "si" lo busca por dni y le da la bienvenida, si no lo encuentra le dice que no stá registrado y le toma los datos.
...
function comprar(){
    ...
    do{
        ...
        sigue = prompt("Desea seguir comprando? sí    no");
    }while(sigue.toLowerCase() == "si" || sigue.toLowerCase() == "sí");
